...
void HandleSidebarInteraction(
    ...
    SidebarInteractionContext *context = (SidebarInteractionContext *)userData;

    if (pointerData.state == CLAY_POINTER_DATA_PRESSED_THIS_FRAME) {
        if (context->index >= 0 && context->index < context->documentCount) {
            // Select the corresponding document
            selectedDocumentIndex = context->index;
        }
    }
}
        ...
        CLAY(
            ...
            CLAY(
                ...
                CLAY(
                    ...
                    for (int i = 0; i < documentCount; i++) {
                        ...
                        if (i == selectedDocumentIndex) {
                            ...
                            SidebarInteractionContext sidebarInteractionContext = { documents, documentCount, i };
                            CLAY(
                                CLAY_LAYOUT(sidebarButtonLayout),
                                Clay_OnHover(HandleSidebarInteraction, (intptr_t)&sidebarInteractionContext),
                                Clay_Hovered()
                                    ? CLAY_RECTANGLE({
                ...
                CLAY(
                    ...
                    Document selectedDocument = documents[selectedDocumentIndex];
